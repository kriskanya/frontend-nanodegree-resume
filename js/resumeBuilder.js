  ...
  "bio": [
    {
      ...
      "biopic": "http://purrfectcatnames.com/wp-content/uploads/2013/11/Gray-Cat-MorgueFile-Nov16th-2013.jpg",
    }
  ],
  "display": function() {
    // name and role
  ...
  "jobs": [
    {
      ...
      "description": "I mainly write end-to-end tests for the Angular apps using the Protractor testing framework and unit tests with Jasmine.  " +
                     "The different NextGxDx apps are written using the MEAN stack, with some of the backend in C#."
    },
    {
      "employer": "Hulu",
      "title": "Ad Operations",
  ...
  "projects": [
    {
      ...
      "images":
      [
        "http://www.adweek.com/fishbowldc/files/2010/12/hoodie-red-cat.jpg",
        "http://www.adweek.com/fishbowldc/files/2010/12/hoodie-red-cat.jpg"
      ]
    },
    {
      ...
      "description": "Reddit-style site for users to upload their favorite online courseware and comment on them.",
